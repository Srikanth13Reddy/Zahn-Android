...
public class ReadBookListAdapter2 extends RecyclerView.Adapter<ReadBookListAdapter2.MyViewHolder> {
    ...
    public
    ReadBookListAdapter2(ArrayList<FlashcardJsonList2>  booklist, Context mContext, AdapterItemClickListener2 adapterItemClickListener, AdapterResetClickListener adapterResetClickListener) {
    ...
    @Override
    public ReadBookListAdapter2.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_items_books, parent, false);
        ReadBookListAdapter2.MyViewHolder viewHolder = new ReadBookListAdapter2.MyViewHolder(itemLayoutView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final ReadBookListAdapter2.MyViewHolder holder, final int position) {
