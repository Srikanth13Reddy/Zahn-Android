...
import com.kenzahn.zahn.fragments.ActivityHomeAcronyms;
...
{
    private ActivityHomeAcronyms homeFragmeny;
    ...
    {
        //getExamData();
        homeFragmeny = ActivityHomeAcronyms.newInstance(type,type);
