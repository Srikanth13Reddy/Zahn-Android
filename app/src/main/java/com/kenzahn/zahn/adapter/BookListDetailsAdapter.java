...
public class BookListDetailsAdapter extends RecyclerView.Adapter<BookListDetailsAdapter.MyViewHolder> {
    ...
    public BookListDetailsAdapter(ArrayList<CardContentRes>  booklist, Context mContext, AdapterItemClickListener adapterItemClickListener) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                adapterItemClickListener1.onItemClick(Integer.parseInt(booklist.get(position).getSortOrder()),booklist.get(position).getFlashCardSetID(),"",null);
            }
        });
    ...
    public void shuffle(ArrayList<CardContentRes> mResponse1)
    {
        ...
        for ( int i =0; i<mResponse1.size();i++)
        {
            String query = "UPDATE flashcardcontent " +
                    " SET SortOrder ='" + i+1 + "' WHERE FlashCardID = '" + mResponse1.get(i).getFlashCardID() + "' ";
