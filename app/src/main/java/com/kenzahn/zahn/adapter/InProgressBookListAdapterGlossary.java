...
public class InProgressBookListAdapterGlossary extends RecyclerView.Adapter<InProgressBookListAdapterGlossary.MyViewHolder> {
    ...
    public InProgressBookListAdapterGlossary(ArrayList<FlashcardJsonList>  booklist, Context mContext, AdapterItemClickListener2 adapterItemClickListener, AdapterResetClickListener adapterResetClickListener) {
    ...
    @Override
    public InProgressBookListAdapterGlossary.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_items_books, parent, false);
        InProgressBookListAdapterGlossary.MyViewHolder viewHolder = new InProgressBookListAdapterGlossary.MyViewHolder(itemLayoutView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final InProgressBookListAdapterGlossary.MyViewHolder holder, final int position) {
