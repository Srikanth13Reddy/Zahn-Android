...
public class BookListDetailsLearnAdapter extends RecyclerView.Adapter<BookListDetailsLearnAdapter.MyViewHolder> {
    public DatabaseHandler databaseHandler;
    private int lastPosition;
    private ArrayList<CardContentRes> booklist;
    private final Context mContext;
    private AdapterItemClickListener adapterItemClickListener;
    public BookListDetailsLearnAdapter(ArrayList<CardContentRes>  booklist, Context mContext, AdapterItemClickListener adapterItemClickListener) {
