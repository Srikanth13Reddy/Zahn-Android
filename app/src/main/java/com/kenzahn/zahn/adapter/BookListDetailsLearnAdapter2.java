...
public class BookListDetailsLearnAdapter2 extends RecyclerView.Adapter<BookListDetailsLearnAdapter2.MyViewHolder> {
    public DatabaseHandler databaseHandler;
    private int lastPosition;
    private ArrayList<CardContentRes2> booklist;
    private final Context mContext;
    private AdapterItemClickListener adapterItemClickListener;
    public BookListDetailsLearnAdapter2(ArrayList<CardContentRes2>  booklist, Context mContext, AdapterItemClickListener adapterItemClickListener) {
