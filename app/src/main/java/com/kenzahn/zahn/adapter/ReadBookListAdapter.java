...
public class ReadBookListAdapter extends RecyclerView.Adapter<ReadBookListAdapter.MyViewHolder> {
    ...
    public
    ReadBookListAdapter(ArrayList<FlashcardJsonList>  booklist, Context mContext, AdapterItemClickListener2 adapterItemClickListener, AdapterResetClickListener adapterResetClickListener) {
