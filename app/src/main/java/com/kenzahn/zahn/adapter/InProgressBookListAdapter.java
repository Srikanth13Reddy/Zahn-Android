...
public class InProgressBookListAdapter extends RecyclerView.Adapter<InProgressBookListAdapter.MyViewHolder> {
    ...
    public InProgressBookListAdapter(ArrayList<FlashcardJsonList>  booklist, Context mContext, AdapterItemClickListener2 adapterItemClickListener, AdapterResetClickListener adapterResetClickListener) {
