...
public class UnReadBookListAdapterGlossary extends RecyclerView.Adapter<UnReadBookListAdapterGlossary.MyViewHolder> {
    public DatabaseHandler databaseHandler;
    private int lastPosition;
    private ArrayList<FlashcardJsonList> booklist;
    private final Context mContext;
    private AdapterItemClickListener2 adapterItemClickListener;
    public UnReadBookListAdapterGlossary(ArrayList<FlashcardJsonList>  booklist, Context mContext, AdapterItemClickListener2 adapterItemClickListener) {
    ...
    @Override
    public UnReadBookListAdapterGlossary.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_items_books, parent, false);
        UnReadBookListAdapterGlossary.MyViewHolder viewHolder = new UnReadBookListAdapterGlossary.MyViewHolder(itemLayoutView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final UnReadBookListAdapterGlossary.MyViewHolder holder, final int position) {
