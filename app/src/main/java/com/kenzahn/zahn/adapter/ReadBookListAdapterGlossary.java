...
public class ReadBookListAdapterGlossary extends RecyclerView.Adapter<ReadBookListAdapterGlossary.MyViewHolder> {
    ...
    public
    ReadBookListAdapterGlossary(ArrayList<FlashcardJsonList>  booklist, Context mContext, AdapterItemClickListener2 adapterItemClickListener, AdapterResetClickListener adapterResetClickListener) {
    ...
    @Override
    public ReadBookListAdapterGlossary.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_items_books, parent, false);
        ReadBookListAdapterGlossary.MyViewHolder viewHolder = new ReadBookListAdapterGlossary.MyViewHolder(itemLayoutView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final ReadBookListAdapterGlossary.MyViewHolder holder, final int position) {
